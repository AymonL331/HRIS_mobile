...
void main() {
  testWidgets('a login with no employee (a Super Admin) sees "No employee record" on both tabs, and Settings still works', (tester) async {
    ...
    final mock = MockClient((req) async => http.Response(
          jsonEncode({
            ...
            'data': {
              'token': 'T',
              'user': {'id': 1, 'tenant_id': 1, 'employee_id': null, 'username': 'admin', 'email': 'a@t.test', 'role_name': 'Super Admin', 'must_change_password': 0, 'mobile_access_enabled': 0},
